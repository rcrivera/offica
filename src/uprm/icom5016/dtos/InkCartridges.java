...
public class InkCartridges extends Product{

	private String color,maxyield;


	public InkCartridges() {
		super();
		// TODO Auto-generated constructor stub
	}

	public InkCartridges(String pid, String category, String subcat,
			String pname, String price, String picLink, String brand,
			Integer stock, String description, String model, String color, String maxyield) {
