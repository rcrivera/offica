...
public class FileFolders extends Product {
	String size;
	String color;
	String quantity;
	public FileFolders() {
	...
	public FileFolders(String pid, String category, String subcat,
			String pname, String price, String picLink, String brand,
			Integer stock, String description, String model, String size, String color, String quantity) {
